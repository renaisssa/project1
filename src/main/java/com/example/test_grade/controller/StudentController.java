...
public class StudentController {
    ...
    public Result update(@RequestBody Student student) {
        return userServiceFacade.updateStudent(student);
    }

    @PostMapping
    public Result add(@RequestBody Student student) {
        return userServiceFacade.addStudent(student);
    }

    @GetMapping
    public Result getAllStudents() {
        return userServiceFacade.getAllStudents();
    }

    @DeleteMapping("/{id}")
    public Result deleteById(@PathVariable Long id) {
        return userServiceFacade.deleteStudent(id);
    }

    @GetMapping("/{name}")
    public Result findStudentByName(@PathVariable String name) {
        return userServiceFacade.findStudentsByName(name);
    }
