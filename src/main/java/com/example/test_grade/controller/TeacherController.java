...
public class TeacherController {
    ...
    public Result update(@RequestBody Teacher teacher) {
        return userServiceFacade.updateTeacher(teacher);
    }

    @PostMapping
    public Result add(@RequestBody Teacher teacher) {
        return userServiceFacade.addTeacher(teacher);
    }

    @GetMapping
    public Result getAllTeachers() {
        return userServiceFacade.getAllTeachers();
    }

    @DeleteMapping("/{id}")
    public Result deleteById(@PathVariable Long id) {
        return userServiceFacade.deleteTeacher(id);
    }

    @GetMapping("/{name}")
    public Result findTeacherByName(@PathVariable String name) {
        return userServiceFacade.findTeachersByName(name);
    }
//    @Autowired
